...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error } = await signup(name, email, password, accountType);
        ...
        <CardContent className="space-y-4">
          <div className="text-center space-y-2">
            <p className="text-sm text-muted-foreground">
              Accounts are now created by:
            </p>
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>• <strong>Super Admin</strong> creates Department Admins</li>
              <li>• <strong>Department Admins</strong> create Students & Instructors</li>
            </ul>
          </div>
